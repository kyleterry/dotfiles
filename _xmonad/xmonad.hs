...
myWorkspaceBar    = "dzen2 -x '0' -y '1355' -h '16' -w '870' -ta 'l' -fg '" ++ colorWhiteAlt ++ "' -bg '" ++ colorBlack ++ "' -fn '" ++ dzenFont ++ "' -p -e ''"
myBottomStatusBar = "/home/kyle/bin/bottomstatusbar.sh"
myTopStatusBar    = "/home/kyle/bin/topstatusbar.sh"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask , xK_s), spawn "slimlock")                                                     --Lock screen
